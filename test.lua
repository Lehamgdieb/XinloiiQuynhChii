...
-- =====================================================================
-- BANANA VIP (HOP BOSS + UI) - GIỮ NGUYÊN NHƯNG THÊM CHẶN KHI ĐANG CDK
-- =====================================================================
    ...
    EquipSword(_G.CurrentSword)
                        ...
                        if frags == 6 then
                            ...
                            if boss and boss.Humanoid.Health > 0 then
                                ...
                                -- (giữ nguyên logic mở cửa như script gốc)
                            end
...
task.spawn(function()
    while task.wait(3) do
        if Auto_Quest_Yama_2 and not _G.AutoFarm_Bone then
            pcall(function()
                print("🎯 Yama Q2 (Haze): Đang nhường quyền điều khiển cho Kaitun tự đi làm nhiệm vụ sương mù...")
            end)
        end
    end
end)
