...
-- ==============================================================
-- [ VÁ LỖI NIL VALUE CHO DELTA EXECUTOR ]
-- ==============================================================
pcall(function()
    local env = _G
...
-- Auto Hit (ตีมอนใกล้ + สกิล Z + Melee)
